...
public class KickCommand extends Command {
    public KickCommand() {
        super("Kick", CommandCategory.ADMIN);
        setDescription("Kick Users from your Server");
    ...
    public void onCommand(GuildMessageReceivedEvent e, String[] args) {
        if (args.length > 0) {
            ...
            try {
                target.getUser().openPrivateChannel().complete().sendMessage("You were kicked from " + e.getGuild().getName() + "! Reason: " + reason).queue();
            ...
            e.getChannel().sendMessage("Please Mention the User you want to Kick in the command").queue();
        }
    }
}
