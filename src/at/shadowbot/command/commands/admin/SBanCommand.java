...
public class SBanCommand extends Command {
    public SBanCommand() {
        super("SBan", CommandCategory.ADMIN);
        setDescription("Silent Ban Users from your Server");
        setDisplayEmoji(":gun:");
    ...
    public void onCommand(GuildMessageReceivedEvent e, String[] args) {
        if (args.length > 0) {
            ...
            e.getChannel().sendMessage("Please Mention the User you want to SBan or use a valid ID in the command").queue();
        }
    }
}
