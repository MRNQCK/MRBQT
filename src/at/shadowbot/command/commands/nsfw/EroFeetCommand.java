...
public class EroFeetCommand extends Command {
    public EroFeetCommand() {
        super("EroFeet", CommandCategory.NSFW);
        setDescription("Random EroFeet pic");
    ...
    public MessageEmbed getHentai() {
        ...
        embedBuilder.setTitle("EroFeet");
        try {
            String apiUrl = "https://nekos.life/api/v2/img/erofeet";
